...
namespace MapleLib.WzLib
{
    ...
    public class WzImage : WzObject, IPropertyContainer
    {
        ...
        public bool _ParseImage(bool parseEverything = false)
        {
            if (Parsed)
            {
                return true;
        ...
        {
            this.reader.SetKey(WzMapleVersion.BMS);
            bool ret = _ParseImage(parseEverything);
            if (!ret)
            {
                this.reader.SetKey(WzMapleVersion.EMS);
                ret = _ParseImage(parseEverything);
            }
